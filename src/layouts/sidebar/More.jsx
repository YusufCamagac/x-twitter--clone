...
const More = () => {
  return (
    <Popover className="relative">
      <PopoverButton className="p-3 rounded-full transition-colors inline-flex  items-center gap-5 outline-none  group-hover:bg-[#eff3f41a]">
      ...
      <PopoverPanel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
        ...
        <button className="p-3 h-14 w-full transition-colors inline-flex flex-row items-center gap-5  hover:bg-[#eff3f41a]">
          <div className="w-[26.25px] h-[26.25px] relative ">
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
              <path
                fill="#e7e9ea"
          ...
          <div className=" w-[37px] h-[20px] ml-[150px]">
            <div className="flex flex-col justify-center items-center cursor-pointer text-sm bg-indigo-500">
              <span className="text-[15px]">beta</span>
            </div>
          </div>
        </button>
        <button className="p-3 h-14 w-full transition-colors inline-flex items-center gap-5  hover:bg-[#eff3f41a]">
